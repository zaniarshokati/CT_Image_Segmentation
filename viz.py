...
def split_array_coords(array, idx=0, indy=1):
    x = [array[i][idx] for i in range(len(array))]
...
# Data viz here
x, y = split_array_coords(lung_areas_csv, idx=1, indy=2)
...
plt.figure()
x, _ = split_array_coords(lung_areas_csv, idx=3, indy=2)
